...
<?php
    ...
    <div class=" mt-5 container border rounded shadow pt-4">
        ...
        <p class="sizer text-justify">Mangaluru, is the chief port city of the Indian state of Karnataka. It is located
            about 352 km (219 mi) west of the state capital Bangalore, between the Arabian Sea and the Western Ghats
            mountain range. It is the major city in Karnataka state in all aspects after the capital city Bangalore. It
            is the only city in Karnataka to have all modes of transport - air, road, rail and sea. It is known as the
            Gateway of Karnataka and the Rome of the East. It is the largest city in the Tulu Nadu region of Karnataka.
            Mangaluru is well connected by air, road and rail. It is 342 kms from Goa, 1050kms from Mumbai,450 kms from
            Cochin on NH17 and 380kms from Bengaluru on NH48.
        </p>
    </div>
    ...
    <div class=" mt-5 container border rounded shadow pt-4">
        ...
        <p class="sizer text-justify"><span class="span1 font-weight-bold">Mangaluru</span> offers a lot to its tourists
            ...
            Places to visit near Mangaluru includes Tannirbhavi Beach, Kadri Manjunath Temple, Panambur Beach, Sultan
            Battery, Mangaladevi Temple, Bejai Museum, Pilikula Park & Golf Course, Milagres Church and many others.
        </p>
    </div>
    <!--IMAGE BOX-->
